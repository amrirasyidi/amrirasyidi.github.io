...
date: 2024-11-03
excerpt: Spatial queries, quick visualization, and open source data.
tags: [data-science, how-to, python, geospatial]
image: "/assets/blog/images/20241103_2_thumbnail_example.png"
---
...
<Figure src="/assets/blog/images/20241103_1_final_result.png" alt="Final result" />
...
<Figure src="https://imgs.xkcd.com/comics/standards.png" alt="xkcd - standards" />
...
<Figure id="stac-structure" src="https://stacspec.org/public/images-original/intro-images/Catalog-layout.jpeg" alt="most relevant image for this post">
  most relevant image for this post
</Figure>
...
2. From the collection, filter to get our item of interest
3. From the STAC item, get the asset and open it using raterio.
...
2. [rasterio](https://rasterio.readthedocs.io/en/stable/) - for the imagery analysis and previewing.
3. [geopandas](https://geopandas.org/en/stable/docs.html) - a minor dataframe-based analysis will be done, "normal" pandas will also do.
4. [duckdb](https://duckdb.org/) - optional - I'm using this because previously I also used duckdb to store some relevant geospatial information.
...
2. Microsoft Planetary - `https://planetarycomputer.microsoft.com/api/stac/v1`

There also *might* be from [source.coop](https://source.coop/), but I'm not sure do they have their own STAC client or they will refer you to other links.
...
The search object contains some items inside it (refer to the [structure](#stac-structure) if you are not sure), you can look at it by iterating through it.
...
<Figure id="thumbnail-example" src="/assets/blog/images/20241103_2_thumbnail_example.png" alt="da thumbnail">
  da thumbnail
</Figure>
...
To get the final result like at the [start of this post](#the-end-result) you only need to use the near-infrared band then overlay the geometry on top of the imagery plot. As always, you can check the complete code on [my repository](https://gitlab.com/comrades_0/data_reading/-/blob/master/notebook/2_sentinel_from_copernicus.ipynb?ref_type=heads).
